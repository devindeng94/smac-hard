...
class StarCraft2Env(MultiAgentEnv):
    ...
    def reset(self):
        ...
        try:
            ...
            self._obs, self._ability = obs[0]
            

            self.blue_obs, self.blue_ability = obs[1]
            self.init_units()
    ...
    def step(self, actions):
        ...
        blue_sc_actions = self.dts_script.script(self.enemies, self.agents, self.blue_ability, self._episode_steps)
